            ...
            <div>
                {paintings.map(paint => (
                    <div key={paint.id} className='painting-container'>
                        <h3>{paint.name}</h3>
                        {paint.price === 'SOLD' ? <p className='painting-sold'>{paint.price}</p> : <p className='painting-price'>{paint.price}<strong className='painting-price'> USD</strong></p>}
                        <img className='paintings' src={paint.src} alt='art'></img>
                        <div>
                            <button id={paint.id} className='galleryBuyBtn' onClick={buyPainting}>BUY</button>
                        </div>
                    </div>
                ))}
            </div>
